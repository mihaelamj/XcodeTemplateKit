...
| Docs & scripts | `documents/`, `Scripts/` | Detailed parsing strategy, automation helpers. |
...
- **Key files**:
  ...
  - `documents/SwiftUIOutlineAnimationPlan.md` — records the remediation strategy and data guidelines for large outlines.
