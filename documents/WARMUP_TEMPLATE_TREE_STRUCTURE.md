...
- `documents/ROADMAP.md` - Complete project vision
- `documents/PHASE_0_GENERATION_PLAN.md` - Generation strategy
- `documents/TEMPLATE_TYPES_GENERATION.md` - All template types
- `documents/BUILD_SETTINGS_SCOPE.md` - Scope boundaries
