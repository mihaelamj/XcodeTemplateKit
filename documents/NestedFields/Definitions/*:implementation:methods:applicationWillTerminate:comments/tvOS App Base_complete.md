# *:implementation:methods:applicationWillTerminate:comments - Complete Context

**Template**: tvOS App Base.xctemplate
**Field Path**: `Definitions.*:implementation:methods:applicationWillTerminate:comments`
