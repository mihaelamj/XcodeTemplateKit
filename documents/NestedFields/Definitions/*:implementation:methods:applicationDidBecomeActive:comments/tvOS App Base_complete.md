# *:implementation:methods:applicationDidBecomeActive:comments - Complete Context

**Template**: tvOS App Base.xctemplate
**Field Path**: `Definitions.*:implementation:methods:applicationDidBecomeActive:comments`
