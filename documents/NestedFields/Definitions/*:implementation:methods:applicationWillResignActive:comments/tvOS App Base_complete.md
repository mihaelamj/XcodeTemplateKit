# *:implementation:methods:applicationWillResignActive:comments - Complete Context

**Template**: tvOS App Base.xctemplate
**Field Path**: `Definitions.*:implementation:methods:applicationWillResignActive:comments`
