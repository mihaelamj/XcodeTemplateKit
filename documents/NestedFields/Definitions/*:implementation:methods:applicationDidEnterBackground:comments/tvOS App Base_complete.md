# *:implementation:methods:applicationDidEnterBackground:comments - Complete Context

**Template**: tvOS App Base.xctemplate
**Field Path**: `Definitions.*:implementation:methods:applicationDidEnterBackground:comments`
