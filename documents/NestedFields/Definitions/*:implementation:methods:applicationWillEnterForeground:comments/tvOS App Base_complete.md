# *:implementation:methods:applicationWillEnterForeground:comments - Complete Context

**Template**: tvOS App Base.xctemplate
**Field Path**: `Definitions.*:implementation:methods:applicationWillEnterForeground:comments`
