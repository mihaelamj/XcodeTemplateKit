# OptionConstraints - Complete Context

**Template**: macOS App UI Test Bundle.xctemplate
**Field Path**: `OptionConstraints`
...
<dict>
	<key>Ancestors</key>
	<array>
		<string>com.apple.dt.unit.osxUITestBundleBase</string>
	</array>
	<key>Identifier</key>
