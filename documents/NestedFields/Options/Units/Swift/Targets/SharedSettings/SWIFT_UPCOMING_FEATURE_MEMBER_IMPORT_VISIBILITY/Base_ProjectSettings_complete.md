# SWIFT_UPCOMING_FEATURE_MEMBER_IMPORT_VISIBILITY - Complete Context

**Template**: Base_ProjectSettings.xctemplate
**Field Path**: `Options[].Units.Swift.Targets[].SharedSettings.SWIFT_UPCOMING_FEATURE_MEMBER_IMPORT_VISIBILITY`
				...
				<dict>
					...
					<array>
						<dict>
							...
							<dict>
								<key>SWIFT_APPROACHABLE_CONCURRENCY</key>
								<string>YES</string>
								<key>SWIFT_UPCOMING_FEATURE_MEMBER_IMPORT_VISIBILITY</key>
								<string>YES</string>
