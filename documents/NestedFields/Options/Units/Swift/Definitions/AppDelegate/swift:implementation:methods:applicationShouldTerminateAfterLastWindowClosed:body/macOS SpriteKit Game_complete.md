# swift:implementation:methods:applicationShouldTerminateAfterLastWindowClosed:body - Complete Context

**Template**: macOS SpriteKit Game.xctemplate
**Field Path**: `Options[].Units.Swift.Definitions.AppDelegate.swift:implementation:methods:applicationShouldTerminateAfterLastWindowClosed:body`
...
<dict>
	...
	<dict>
		...
		<dict>
			<key>Path</key>
			<string>SpriteKit_Main.storyboard</string>
			<key>SortOrder</key>
			<integer>101</integer>
		</dict>
	</dict>
			...
			<dict>
				...
				<dict>
					...
					<dict>
						...
						<dict>
							<key>Path</key>
							<string>SpriteKit_ViewController.h</string>
						</dict>
						<key>GameViewController.m</key>
						<dict>
							<key>Path</key>
							<string>SpriteKit_ViewController.m</string>
						</dict>
					</dict>
					<key>Nodes</key>
					<array>
				...
				<dict>
					...
					<dict>
						...
						<dict>
							<key>Path</key>
							<string>SpriteKit_ViewController.swift</string>
						</dict>
					</dict>
					<key>Nodes</key>
					<array>
