# PRODUCT_BUNDLE_IDENTIFIER - Complete Context

**Template**: iOS Safari Extension.xctemplate
**Field Path**: `Options[].Units.ForAppTemplate.Targets[].SharedSettings.PRODUCT_BUNDLE_IDENTIFIER`
...
&lt;/dict&gt;
	...
	<array>
		<dict>
			<key>Name</key>
			<string>___PARENTPACKAGENAME___ Extension (iOS)</string>
			<key>SharedSettings</key>
			<dict>
			...
			<string>com.apple.dt.safariExtension.iOS</string>
		</dict>
	</array>
</dict>
</plist>
