# INFOPLIST_KEY_UISupportedInterfaceOrientations_iPad - Complete Context

**Template**: iOS App Base.xctemplate
**Field Path**: `Targets[].SharedSettings.INFOPLIST_KEY_UISupportedInterfaceOrientations_iPad`
