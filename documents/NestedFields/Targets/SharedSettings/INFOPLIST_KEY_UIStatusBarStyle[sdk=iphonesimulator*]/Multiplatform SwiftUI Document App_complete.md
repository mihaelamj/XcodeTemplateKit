# INFOPLIST_KEY_UIStatusBarStyle[sdk=iphonesimulator*] - Complete Context

**Template**: Multiplatform SwiftUI Document App.xctemplate
**Field Path**: `Targets[].SharedSettings.INFOPLIST_KEY_UIStatusBarStyle[sdk=iphonesimulator*]`
