# INFOPLIST_KEY_UISupportedInterfaceOrientations_iPhone - Complete Context

**Template**: iOS App Base.xctemplate
**Field Path**: `Targets[].SharedSettings.INFOPLIST_KEY_UISupportedInterfaceOrientations_iPhone`
