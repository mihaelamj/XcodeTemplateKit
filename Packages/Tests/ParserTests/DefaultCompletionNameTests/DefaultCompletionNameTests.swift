...
struct DefaultCompletionNameTests {
    ...
    func parseApp_Entity() throws {
        let fixturePath = #filePath.replacingOccurrences(of: "ParserTests/DefaultCompletionNameTests/DefaultCompletionNameTests.swift", with: "Fixtures/DefaultCompletionName/App_Entity_value.plist")
    ...
    func parseApp_Enum() throws {
        let fixturePath = #filePath.replacingOccurrences(of: "ParserTests/DefaultCompletionNameTests/DefaultCompletionNameTests.swift", with: "Fixtures/DefaultCompletionName/App_Enum_value.plist")
        let plistData = try Data(contentsOf: URL(fileURLWithPath: fixturePath))
        let plist = try PropertyListSerialization.propertyList(from: plistData, format: nil) as! [String: Any]
    ...
    func parseApp_Privacy() throws {
        let fixturePath = #filePath.replacingOccurrences(of: "ParserTests/DefaultCompletionNameTests/DefaultCompletionNameTests.swift", with: "Fixtures/DefaultCompletionName/App_Privacy_value.plist")
        let plistData = try Data(contentsOf: URL(fileURLWithPath: fixturePath))
        let plist = try PropertyListSerialization.propertyList(from: plistData, format: nil) as! [String: Any]
    ...
    func parseArticle_File() throws {
        let fixturePath = #filePath.replacingOccurrences(of: "ParserTests/DefaultCompletionNameTests/DefaultCompletionNameTests.swift", with: "Fixtures/DefaultCompletionName/Article_File_value.plist")
        let plistData = try Data(contentsOf: URL(fileURLWithPath: fixturePath))
        let plist = try PropertyListSerialization.propertyList(from: plistData, format: nil) as! [String: Any]
    ...
    func parseAssembly_File() throws {
        let fixturePath = #filePath.replacingOccurrences(of: "ParserTests/DefaultCompletionNameTests/DefaultCompletionNameTests.swift", with: "Fixtures/DefaultCompletionName/Assembly_File_value.plist")
        let plistData = try Data(contentsOf: URL(fileURLWithPath: fixturePath))
        let plist = try PropertyListSerialization.propertyList(from: plistData, format: nil) as! [String: Any]
    ...
    func parseAsset_Catalog() throws {
        let fixturePath = #filePath.replacingOccurrences(of: "ParserTests/DefaultCompletionNameTests/DefaultCompletionNameTests.swift", with: "Fixtures/DefaultCompletionName/Asset_Catalog_value.plist")
        let plistData = try Data(contentsOf: URL(fileURLWithPath: fixturePath))
        let plist = try PropertyListSerialization.propertyList(from: plistData, format: nil) as! [String: Any]
    ...
    func parseBuild_Tool_Plug_in() throws {
        let fixturePath = #filePath.replacingOccurrences(of: "ParserTests/DefaultCompletionNameTests/DefaultCompletionNameTests.swift", with: "Fixtures/DefaultCompletionName/Build_Tool_Plug-in_value.plist")
        let plistData = try Data(contentsOf: URL(fileURLWithPath: fixturePath))
        let plist = try PropertyListSerialization.propertyList(from: plistData, format: nil) as! [String: Any]
    ...
    func parseC_File() throws {
        let fixturePath = #filePath.replacingOccurrences(of: "ParserTests/DefaultCompletionNameTests/DefaultCompletionNameTests.swift", with: "Fixtures/DefaultCompletionName/C++_File_value.plist")
        let plistData = try Data(contentsOf: URL(fileURLWithPath: fixturePath))
        let plist = try PropertyListSerialization.propertyList(from: plistData, format: nil) as! [String: Any]
    ...
    func parseCLIPS_File() throws {
        let fixturePath = #filePath.replacingOccurrences(of: "ParserTests/DefaultCompletionNameTests/DefaultCompletionNameTests.swift", with: "Fixtures/DefaultCompletionName/CLIPS_File_value.plist")
        let plistData = try Data(contentsOf: URL(fileURLWithPath: fixturePath))
        let plist = try PropertyListSerialization.propertyList(from: plistData, format: nil) as! [String: Any]
    ...
    func parseC_File_2() throws {
        let fixturePath = #filePath.replacingOccurrences(of: "ParserTests/DefaultCompletionNameTests/DefaultCompletionNameTests.swift", with: "Fixtures/DefaultCompletionName/C_File_value.plist")
        let plistData = try Data(contentsOf: URL(fileURLWithPath: fixturePath))
        let plist = try PropertyListSerialization.propertyList(from: plistData, format: nil) as! [String: Any]
    ...
    func parseCommand_Plug_in() throws {
        let fixturePath = #filePath.replacingOccurrences(of: "ParserTests/DefaultCompletionNameTests/DefaultCompletionNameTests.swift", with: "Fixtures/DefaultCompletionName/Command_Plug-in_value.plist")
        let plistData = try Data(contentsOf: URL(fileURLWithPath: fixturePath))
        let plist = try PropertyListSerialization.propertyList(from: plistData, format: nil) as! [String: Any]
    ...
    func parseConfiguration_Settings_File() throws {
        let fixturePath = #filePath.replacingOccurrences(of: "ParserTests/DefaultCompletionNameTests/DefaultCompletionNameTests.swift", with: "Fixtures/DefaultCompletionName/Configuration_Settings_File_value.plist")
        let plistData = try Data(contentsOf: URL(fileURLWithPath: fixturePath))
        let plist = try PropertyListSerialization.propertyList(from: plistData, format: nil) as! [String: Any]
    ...
    func parseDocumentation_Catalog() throws {
        let fixturePath = #filePath.replacingOccurrences(of: "ParserTests/DefaultCompletionNameTests/DefaultCompletionNameTests.swift", with: "Fixtures/DefaultCompletionName/Documentation_Catalog_value.plist")
        let plistData = try Data(contentsOf: URL(fileURLWithPath: fixturePath))
        let plist = try PropertyListSerialization.propertyList(from: plistData, format: nil) as! [String: Any]
    ...
    func parseEmpty_File() throws {
        let fixturePath = #filePath.replacingOccurrences(of: "ParserTests/DefaultCompletionNameTests/DefaultCompletionNameTests.swift", with: "Fixtures/DefaultCompletionName/Empty_File_value.plist")
        let plistData = try Data(contentsOf: URL(fileURLWithPath: fixturePath))
        let plist = try PropertyListSerialization.propertyList(from: plistData, format: nil) as! [String: Any]
    ...
    func parseEmpty() throws {
        let fixturePath = #filePath.replacingOccurrences(of: "ParserTests/DefaultCompletionNameTests/DefaultCompletionNameTests.swift", with: "Fixtures/DefaultCompletionName/Empty_value.plist")
        let plistData = try Data(contentsOf: URL(fileURLWithPath: fixturePath))
        let plist = try PropertyListSerialization.propertyList(from: plistData, format: nil) as! [String: Any]
    ...
    func parseExports_File() throws {
        let fixturePath = #filePath.replacingOccurrences(of: "ParserTests/DefaultCompletionNameTests/DefaultCompletionNameTests.swift", with: "Fixtures/DefaultCompletionName/Exports_File_value.plist")
        let plistData = try Data(contentsOf: URL(fileURLWithPath: fixturePath))
        let plist = try PropertyListSerialization.propertyList(from: plistData, format: nil) as! [String: Any]
    ...
    func parseExtension_File() throws {
        let fixturePath = #filePath.replacingOccurrences(of: "ParserTests/DefaultCompletionNameTests/DefaultCompletionNameTests.swift", with: "Fixtures/DefaultCompletionName/Extension_File_value.plist")
        let plistData = try Data(contentsOf: URL(fileURLWithPath: fixturePath))
        let plist = try PropertyListSerialization.propertyList(from: plistData, format: nil) as! [String: Any]
    ...
    func parseFile_List() throws {
        let fixturePath = #filePath.replacingOccurrences(of: "ParserTests/DefaultCompletionNameTests/DefaultCompletionNameTests.swift", with: "Fixtures/DefaultCompletionName/File_List_value.plist")
        let plistData = try Data(contentsOf: URL(fileURLWithPath: fixturePath))
        let plist = try PropertyListSerialization.propertyList(from: plistData, format: nil) as! [String: Any]
    ...
    func parseHeader_File() throws {
        let fixturePath = #filePath.replacingOccurrences(of: "ParserTests/DefaultCompletionNameTests/DefaultCompletionNameTests.swift", with: "Fixtures/DefaultCompletionName/Header_File_value.plist")
        let plistData = try Data(contentsOf: URL(fileURLWithPath: fixturePath))
        let plist = try PropertyListSerialization.propertyList(from: plistData, format: nil) as! [String: Any]
    ...
    func parseINIntent_subclass() throws {
        let fixturePath = #filePath.replacingOccurrences(of: "ParserTests/DefaultCompletionNameTests/DefaultCompletionNameTests.swift", with: "Fixtures/DefaultCompletionName/INIntent_subclass_value.plist")
        let plistData = try Data(contentsOf: URL(fileURLWithPath: fixturePath))
        let plist = try PropertyListSerialization.propertyList(from: plistData, format: nil) as! [String: Any]
    ...
    func parseLibrary() throws {
        let fixturePath = #filePath.replacingOccurrences(of: "ParserTests/DefaultCompletionNameTests/DefaultCompletionNameTests.swift", with: "Fixtures/DefaultCompletionName/Library_value.plist")
        let plistData = try Data(contentsOf: URL(fileURLWithPath: fixturePath))
        let plist = try PropertyListSerialization.propertyList(from: plistData, format: nil) as! [String: Any]
    ...
    func parseLink_action() throws {
        let fixturePath = #filePath.replacingOccurrences(of: "ParserTests/DefaultCompletionNameTests/DefaultCompletionNameTests.swift", with: "Fixtures/DefaultCompletionName/Link_action_value.plist")
        let plistData = try Data(contentsOf: URL(fileURLWithPath: fixturePath))
        let plist = try PropertyListSerialization.propertyList(from: plistData, format: nil) as! [String: Any]
    ...
    func parseMain_Menu() throws {
        let fixturePath = #filePath.replacingOccurrences(of: "ParserTests/DefaultCompletionNameTests/DefaultCompletionNameTests.swift", with: "Fixtures/DefaultCompletionName/Main_Menu_value.plist")
        let plistData = try Data(contentsOf: URL(fileURLWithPath: fixturePath))
        let plist = try PropertyListSerialization.propertyList(from: plistData, format: nil) as! [String: Any]
    ...
    func parseMarkdown_File() throws {
        let fixturePath = #filePath.replacingOccurrences(of: "ParserTests/DefaultCompletionNameTests/DefaultCompletionNameTests.swift", with: "Fixtures/DefaultCompletionName/Markdown_File_value.plist")
        let plistData = try Data(contentsOf: URL(fileURLWithPath: fixturePath))
        let plist = try PropertyListSerialization.propertyList(from: plistData, format: nil) as! [String: Any]
    ...
    func parseMetal_File() throws {
        let fixturePath = #filePath.replacingOccurrences(of: "ParserTests/DefaultCompletionNameTests/DefaultCompletionNameTests.swift", with: "Fixtures/DefaultCompletionName/Metal_File_value.plist")
        let plistData = try Data(contentsOf: URL(fileURLWithPath: fixturePath))
        let plist = try PropertyListSerialization.propertyList(from: plistData, format: nil) as! [String: Any]
    ...
    func parseModule_Map() throws {
        let fixturePath = #filePath.replacingOccurrences(of: "ParserTests/DefaultCompletionNameTests/DefaultCompletionNameTests.swift", with: "Fixtures/DefaultCompletionName/Module_Map_value.plist")
        let plistData = try Data(contentsOf: URL(fileURLWithPath: fixturePath))
        let plist = try PropertyListSerialization.propertyList(from: plistData, format: nil) as! [String: Any]
    ...
    func parseObjective_C_File() throws {
        let fixturePath = #filePath.replacingOccurrences(of: "ParserTests/DefaultCompletionNameTests/DefaultCompletionNameTests.swift", with: "Fixtures/DefaultCompletionName/Objective-C_File_value.plist")
        let plistData = try Data(contentsOf: URL(fileURLWithPath: fixturePath))
        let plist = try PropertyListSerialization.propertyList(from: plistData, format: nil) as! [String: Any]
    ...
    func parsePCH_File() throws {
        let fixturePath = #filePath.replacingOccurrences(of: "ParserTests/DefaultCompletionNameTests/DefaultCompletionNameTests.swift", with: "Fixtures/DefaultCompletionName/PCH_File_value.plist")
        let plistData = try Data(contentsOf: URL(fileURLWithPath: fixturePath))
        let plist = try PropertyListSerialization.propertyList(from: plistData, format: nil) as! [String: Any]
    ...
    func parsePackage_Swift_File() throws {
        let fixturePath = #filePath.replacingOccurrences(of: "ParserTests/DefaultCompletionNameTests/DefaultCompletionNameTests.swift", with: "Fixtures/DefaultCompletionName/Package_Swift_File_value.plist")
        let plistData = try Data(contentsOf: URL(fileURLWithPath: fixturePath))
        let plist = try PropertyListSerialization.propertyList(from: plistData, format: nil) as! [String: Any]
    ...
    func parsePackage_Test_Case() throws {
        let fixturePath = #filePath.replacingOccurrences(of: "ParserTests/DefaultCompletionNameTests/DefaultCompletionNameTests.swift", with: "Fixtures/DefaultCompletionName/Package_Test_Case_value.plist")
        let plistData = try Data(contentsOf: URL(fileURLWithPath: fixturePath))
        let plist = try PropertyListSerialization.propertyList(from: plistData, format: nil) as! [String: Any]
    ...
    func parsePlayground_Page() throws {
        let fixturePath = #filePath.replacingOccurrences(of: "ParserTests/DefaultCompletionNameTests/DefaultCompletionNameTests.swift", with: "Fixtures/DefaultCompletionName/Playground_Page_value.plist")
        let plistData = try Data(contentsOf: URL(fileURLWithPath: fixturePath))
        let plist = try PropertyListSerialization.propertyList(from: plistData, format: nil) as! [String: Any]
    ...
    func parseRTF_File() throws {
        let fixturePath = #filePath.replacingOccurrences(of: "ParserTests/DefaultCompletionNameTests/DefaultCompletionNameTests.swift", with: "Fixtures/DefaultCompletionName/RTF_File_value.plist")
        let plistData = try Data(contentsOf: URL(fileURLWithPath: fixturePath))
        let plist = try PropertyListSerialization.propertyList(from: plistData, format: nil) as! [String: Any]
    ...
    func parseSceneKit_Asset_Cache() throws {
        let fixturePath = #filePath.replacingOccurrences(of: "ParserTests/DefaultCompletionNameTests/DefaultCompletionNameTests.swift", with: "Fixtures/DefaultCompletionName/SceneKit_Asset_Cache_value.plist")
        let plistData = try Data(contentsOf: URL(fileURLWithPath: fixturePath))
        let plist = try PropertyListSerialization.propertyList(from: plistData, format: nil) as! [String: Any]
    ...
    func parseSceneKit_Asset_Catalog() throws {
        let fixturePath = #filePath.replacingOccurrences(of: "ParserTests/DefaultCompletionNameTests/DefaultCompletionNameTests.swift", with: "Fixtures/DefaultCompletionName/SceneKit_Asset_Catalog_value.plist")
        let plistData = try Data(contentsOf: URL(fileURLWithPath: fixturePath))
        let plist = try PropertyListSerialization.propertyList(from: plistData, format: nil) as! [String: Any]
    ...
    func parseSceneKit_Scene_File() throws {
        let fixturePath = #filePath.replacingOccurrences(of: "ParserTests/DefaultCompletionNameTests/DefaultCompletionNameTests.swift", with: "Fixtures/DefaultCompletionName/SceneKit_Scene_File_value.plist")
        let plistData = try Data(contentsOf: URL(fileURLWithPath: fixturePath))
        let plist = try PropertyListSerialization.propertyList(from: plistData, format: nil) as! [String: Any]
    ...
    func parseShell_Script() throws {
        let fixturePath = #filePath.replacingOccurrences(of: "ParserTests/DefaultCompletionNameTests/DefaultCompletionNameTests.swift", with: "Fixtures/DefaultCompletionName/Shell_Script_value.plist")
        let plistData = try Data(contentsOf: URL(fileURLWithPath: fixturePath))
        let plist = try PropertyListSerialization.propertyList(from: plistData, format: nil) as! [String: Any]
    ...
    func parseSiriKit_Intent_Definition_File() throws {
        let fixturePath = #filePath.replacingOccurrences(of: "ParserTests/DefaultCompletionNameTests/DefaultCompletionNameTests.swift", with: "Fixtures/DefaultCompletionName/SiriKit_Intent_Definition_File_value.plist")
        let plistData = try Data(contentsOf: URL(fileURLWithPath: fixturePath))
        let plist = try PropertyListSerialization.propertyList(from: plistData, format: nil) as! [String: Any]
    ...
    func parseSources_Folder_Swift_File() throws {
        let fixturePath = #filePath.replacingOccurrences(of: "ParserTests/DefaultCompletionNameTests/DefaultCompletionNameTests.swift", with: "Fixtures/DefaultCompletionName/Sources_Folder_Swift_File_value.plist")
        let plistData = try Data(contentsOf: URL(fileURLWithPath: fixturePath))
        let plist = try PropertyListSerialization.propertyList(from: plistData, format: nil) as! [String: Any]
    ...
    func parseSpriteKit_Action() throws {
        let fixturePath = #filePath.replacingOccurrences(of: "ParserTests/DefaultCompletionNameTests/DefaultCompletionNameTests.swift", with: "Fixtures/DefaultCompletionName/SpriteKit_Action_value.plist")
        let plistData = try Data(contentsOf: URL(fileURLWithPath: fixturePath))
        let plist = try PropertyListSerialization.propertyList(from: plistData, format: nil) as! [String: Any]
    ...
    func parseSpriteKit_Particle_File() throws {
        let fixturePath = #filePath.replacingOccurrences(of: "ParserTests/DefaultCompletionNameTests/DefaultCompletionNameTests.swift", with: "Fixtures/DefaultCompletionName/SpriteKit_Particle_File_value.plist")
        let plistData = try Data(contentsOf: URL(fileURLWithPath: fixturePath))
        let plist = try PropertyListSerialization.propertyList(from: plistData, format: nil) as! [String: Any]
    ...
    func parseSpriteKit_Scene() throws {
        let fixturePath = #filePath.replacingOccurrences(of: "ParserTests/DefaultCompletionNameTests/DefaultCompletionNameTests.swift", with: "Fixtures/DefaultCompletionName/SpriteKit_Scene_value.plist")
        let plistData = try Data(contentsOf: URL(fileURLWithPath: fixturePath))
        let plist = try PropertyListSerialization.propertyList(from: plistData, format: nil) as! [String: Any]
    ...
    func parseSpriteKit_Tile_Set() throws {
        let fixturePath = #filePath.replacingOccurrences(of: "ParserTests/DefaultCompletionNameTests/DefaultCompletionNameTests.swift", with: "Fixtures/DefaultCompletionName/SpriteKit_Tile_Set_value.plist")
        let plistData = try Data(contentsOf: URL(fileURLWithPath: fixturePath))
        let plist = try PropertyListSerialization.propertyList(from: plistData, format: nil) as! [String: Any]
    ...
    func parseStrings_File_Legacy() throws {
        let fixturePath = #filePath.replacingOccurrences(of: "ParserTests/DefaultCompletionNameTests/DefaultCompletionNameTests.swift", with: "Fixtures/DefaultCompletionName/Strings_File_(Legacy)_value.plist")
        let plistData = try Data(contentsOf: URL(fileURLWithPath: fixturePath))
        let plist = try PropertyListSerialization.propertyList(from: plistData, format: nil) as! [String: Any]
    ...
    func parseStringsdict_File_Legacy() throws {
        let fixturePath = #filePath.replacingOccurrences(of: "ParserTests/DefaultCompletionNameTests/DefaultCompletionNameTests.swift", with: "Fixtures/DefaultCompletionName/Stringsdict_File_(Legacy)_value.plist")
        let plistData = try Data(contentsOf: URL(fileURLWithPath: fixturePath))
        let plist = try PropertyListSerialization.propertyList(from: plistData, format: nil) as! [String: Any]
    ...
    func parseSwiftUI_View() throws {
        let fixturePath = #filePath.replacingOccurrences(of: "ParserTests/DefaultCompletionNameTests/DefaultCompletionNameTests.swift", with: "Fixtures/DefaultCompletionName/SwiftUI_View_value.plist")
        let plistData = try Data(contentsOf: URL(fileURLWithPath: fixturePath))
        let plist = try PropertyListSerialization.propertyList(from: plistData, format: nil) as! [String: Any]
    ...
    func parseSwift_File() throws {
        let fixturePath = #filePath.replacingOccurrences(of: "ParserTests/DefaultCompletionNameTests/DefaultCompletionNameTests.swift", with: "Fixtures/DefaultCompletionName/Swift_File_value.plist")
        let plistData = try Data(contentsOf: URL(fileURLWithPath: fixturePath))
        let plist = try PropertyListSerialization.propertyList(from: plistData, format: nil) as! [String: Any]
    ...
    func parseSwift_Macro() throws {
        let fixturePath = #filePath.replacingOccurrences(of: "ParserTests/DefaultCompletionNameTests/DefaultCompletionNameTests.swift", with: "Fixtures/DefaultCompletionName/Swift_Macro_value.plist")
        let plistData = try Data(contentsOf: URL(fileURLWithPath: fixturePath))
        let plist = try PropertyListSerialization.propertyList(from: plistData, format: nil) as! [String: Any]
    ...
    func parseSwift_Testing_Unit_Test() throws {
        let fixturePath = #filePath.replacingOccurrences(of: "ParserTests/DefaultCompletionNameTests/DefaultCompletionNameTests.swift", with: "Fixtures/DefaultCompletionName/Swift_Testing_Unit_Test_value.plist")
        let plistData = try Data(contentsOf: URL(fileURLWithPath: fixturePath))
        let plist = try PropertyListSerialization.propertyList(from: plistData, format: nil) as! [String: Any]
    ...
    func parseTest_Plan() throws {
        let fixturePath = #filePath.replacingOccurrences(of: "ParserTests/DefaultCompletionNameTests/DefaultCompletionNameTests.swift", with: "Fixtures/DefaultCompletionName/Test_Plan_value.plist")
        let plistData = try Data(contentsOf: URL(fileURLWithPath: fixturePath))
        let plist = try PropertyListSerialization.propertyList(from: plistData, format: nil) as! [String: Any]
    ...
    func parseTouch_Alternatives_Property_List() throws {
        let fixturePath = #filePath.replacingOccurrences(of: "ParserTests/DefaultCompletionNameTests/DefaultCompletionNameTests.swift", with: "Fixtures/DefaultCompletionName/Touch_Alternatives_Property_List_value.plist")
        let plistData = try Data(contentsOf: URL(fileURLWithPath: fixturePath))
        let plist = try PropertyListSerialization.propertyList(from: plistData, format: nil) as! [String: Any]
    ...
    func parseTransient_App_Entity() throws {
        let fixturePath = #filePath.replacingOccurrences(of: "ParserTests/DefaultCompletionNameTests/DefaultCompletionNameTests.swift", with: "Fixtures/DefaultCompletionName/Transient_App_Entity_value.plist")
        let plistData = try Data(contentsOf: URL(fileURLWithPath: fixturePath))
        let plist = try PropertyListSerialization.propertyList(from: plistData, format: nil) as! [String: Any]
    ...
    func parseTutorial_File() throws {
        let fixturePath = #filePath.replacingOccurrences(of: "ParserTests/DefaultCompletionNameTests/DefaultCompletionNameTests.swift", with: "Fixtures/DefaultCompletionName/Tutorial_File_value.plist")
        let plistData = try Data(contentsOf: URL(fileURLWithPath: fixturePath))
        let plist = try PropertyListSerialization.propertyList(from: plistData, format: nil) as! [String: Any]
    ...
    func parseTutorial_Table_of_Contents_File() throws {
        let fixturePath = #filePath.replacingOccurrences(of: "ParserTests/DefaultCompletionNameTests/DefaultCompletionNameTests.swift", with: "Fixtures/DefaultCompletionName/Tutorial_Table_of_Contents_File_value.plist")
        let plistData = try Data(contentsOf: URL(fileURLWithPath: fixturePath))
        let plist = try PropertyListSerialization.propertyList(from: plistData, format: nil) as! [String: Any]
    ...
    func parseXCTest_UI_Test() throws {
        let fixturePath = #filePath.replacingOccurrences(of: "ParserTests/DefaultCompletionNameTests/DefaultCompletionNameTests.swift", with: "Fixtures/DefaultCompletionName/XCTest_UI_Test_value.plist")
        let plistData = try Data(contentsOf: URL(fileURLWithPath: fixturePath))
        let plist = try PropertyListSerialization.propertyList(from: plistData, format: nil) as! [String: Any]
    ...
    func parseXCTest_Unit_Test() throws {
        let fixturePath = #filePath.replacingOccurrences(of: "ParserTests/DefaultCompletionNameTests/DefaultCompletionNameTests.swift", with: "Fixtures/DefaultCompletionName/XCTest_Unit_Test_value.plist")
        let plistData = try Data(contentsOf: URL(fileURLWithPath: fixturePath))
        let plist = try PropertyListSerialization.propertyList(from: plistData, format: nil) as! [String: Any]
