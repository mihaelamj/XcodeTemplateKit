...
struct ComponentsTests {
    ...
    func parseAudio_Unit_Extension_App() throws {
        let fixturePath = #filePath.replacingOccurrences(of: "ParserTests/ComponentsTests/ComponentsTests.swift", with: "Fixtures/Components/Audio_Unit_Extension_App_value.plist")
    ...
    func parseSafari_Extension_App() throws {
        let fixturePath = #filePath.replacingOccurrences(of: "ParserTests/ComponentsTests/ComponentsTests.swift", with: "Fixtures/Components/Safari_Extension_App_value.plist")
        let plistData = try Data(contentsOf: URL(fileURLWithPath: fixturePath))
        let plist = try PropertyListSerialization.propertyList(from: plistData, format: nil) as! [String: Any]
