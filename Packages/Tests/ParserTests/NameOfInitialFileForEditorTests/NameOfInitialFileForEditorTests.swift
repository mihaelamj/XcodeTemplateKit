...
struct NameOfInitialFileForEditorTests {
    ...
    func parseApp() throws {
        let fixturePath = #filePath.replacingOccurrences(of: "ParserTests/NameOfInitialFileForEditorTests/NameOfInitialFileForEditorTests.swift", with: "Fixtures/NameOfInitialFileForEditor/App_value.plist")
    ...
    func parseDocument_App() throws {
        let fixturePath = #filePath.replacingOccurrences(of: "ParserTests/NameOfInitialFileForEditorTests/NameOfInitialFileForEditorTests.swift", with: "Fixtures/NameOfInitialFileForEditor/Document_App_value.plist")
        let plistData = try Data(contentsOf: URL(fileURLWithPath: fixturePath))
        let plist = try PropertyListSerialization.propertyList(from: plistData, format: nil) as! [String: Any]
    ...
    func parseSafari_Extension_App() throws {
        let fixturePath = #filePath.replacingOccurrences(of: "ParserTests/NameOfInitialFileForEditorTests/NameOfInitialFileForEditorTests.swift", with: "Fixtures/NameOfInitialFileForEditor/Safari_Extension_App_value.plist")
        let plistData = try Data(contentsOf: URL(fileURLWithPath: fixturePath))
        let plist = try PropertyListSerialization.propertyList(from: plistData, format: nil) as! [String: Any]
    ...
    func parseSharedContent_RealityKit_Game() throws {
        let fixturePath = #filePath.replacingOccurrences(of: "ParserTests/NameOfInitialFileForEditorTests/NameOfInitialFileForEditorTests.swift", with: "Fixtures/NameOfInitialFileForEditor/SharedContent_RealityKit_Game_value.plist")
        let plistData = try Data(contentsOf: URL(fileURLWithPath: fixturePath))
        let plist = try PropertyListSerialization.propertyList(from: plistData, format: nil) as! [String: Any]
    ...
    func parseSwiftUI_App_Base() throws {
        let fixturePath = #filePath.replacingOccurrences(of: "ParserTests/NameOfInitialFileForEditorTests/NameOfInitialFileForEditorTests.swift", with: "Fixtures/NameOfInitialFileForEditor/SwiftUI_App_Base_value.plist")
        let plistData = try Data(contentsOf: URL(fileURLWithPath: fixturePath))
        let plist = try PropertyListSerialization.propertyList(from: plistData, format: nil) as! [String: Any]
    ...
    func parseSwiftUI_Document_App_Base() throws {
        let fixturePath = #filePath.replacingOccurrences(of: "ParserTests/NameOfInitialFileForEditorTests/NameOfInitialFileForEditorTests.swift", with: "Fixtures/NameOfInitialFileForEditor/SwiftUI_Document_App_Base_value.plist")
        let plistData = try Data(contentsOf: URL(fileURLWithPath: fixturePath))
        let plist = try PropertyListSerialization.propertyList(from: plistData, format: nil) as! [String: Any]
