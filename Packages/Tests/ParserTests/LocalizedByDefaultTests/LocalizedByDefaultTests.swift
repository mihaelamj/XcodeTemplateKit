...
struct LocalizedByDefaultTests {
    ...
    func parseStrings_File_Legacy() throws {
        let fixturePath = #filePath.replacingOccurrences(of: "ParserTests/LocalizedByDefaultTests/LocalizedByDefaultTests.swift", with: "Fixtures/LocalizedByDefault/Strings_File_(Legacy)_value.plist")
    ...
    func parseStringsdict_File_Legacy() throws {
        let fixturePath = #filePath.replacingOccurrences(of: "ParserTests/LocalizedByDefaultTests/LocalizedByDefaultTests.swift", with: "Fixtures/LocalizedByDefault/Stringsdict_File_(Legacy)_value.plist")
        let plistData = try Data(contentsOf: URL(fileURLWithPath: fixturePath))
        let plist = try PropertyListSerialization.propertyList(from: plistData, format: nil) as! [String: Any]
