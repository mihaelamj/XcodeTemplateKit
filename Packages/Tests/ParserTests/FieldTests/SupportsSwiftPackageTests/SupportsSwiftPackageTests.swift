...
struct SupportsSwiftPackageTests {
    ...
    func parseApp_Privacy() throws {
        let fixturePath = #filePath.replacingOccurrences(
            of: "ParserTests/FieldTests/SupportsSwiftPackageTests/SupportsSwiftPackageTests.swift",
        ...
        let value = (plist["SupportsSwiftPackage"] as? Bool).map { Models.Template.Model.BooleanFormat.fromSwiftBool($0) }
    ...
    func roundTripApp_Privacy() throws {
        ...
        let value = (originalPlist["SupportsSwiftPackage"] as? Bool).map { Models.Template.Model.BooleanFormat.fromSwiftBool($0) }
        ...
        let reparsedValue = (reparsedPlist["SupportsSwiftPackage"] as? Bool).map { Models.Template.Model.BooleanFormat.fromSwiftBool($0) }
    ...
    func parseMissingSupportsSwiftPackage() throws {
        ...
        let value = (testPlist["SupportsSwiftPackage"] as? Bool).map { Models.Template.Model.BooleanFormat.fromSwiftBool($0) }
