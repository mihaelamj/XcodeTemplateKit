...
struct LocalizedByDefaultTests {
    ...
    func parseStrings_File_Legacy() throws {
        let fixturePath = #filePath.replacingOccurrences(
            of: "ParserTests/FieldTests/LocalizedByDefaultTests/LocalizedByDefaultTests.swift",
        ...
        let value = (plist["LocalizedByDefault"] as? Bool).map { Models.Template.Model.BooleanFormat.fromSwiftBool($0) }
    ...
    func roundTripStrings_File_Legacy() throws {
        ...
        let value = (originalPlist["LocalizedByDefault"] as? Bool).map { Models.Template.Model.BooleanFormat.fromSwiftBool($0) }
        ...
        let reparsedValue = (reparsedPlist["LocalizedByDefault"] as? Bool).map { Models.Template.Model.BooleanFormat.fromSwiftBool($0) }
    ...
    func parseMissingLocalizedByDefault() throws {
        ...
        let value = (testPlist["LocalizedByDefault"] as? Bool).map { Models.Template.Model.BooleanFormat.fromSwiftBool($0) }
