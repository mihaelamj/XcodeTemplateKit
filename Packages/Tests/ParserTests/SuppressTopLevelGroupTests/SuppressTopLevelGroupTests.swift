...
struct SuppressTopLevelGroupTests {
    ...
    func parseCompositor_Services() throws {
        let fixturePath = #filePath.replacingOccurrences(of: "ParserTests/SuppressTopLevelGroupTests/SuppressTopLevelGroupTests.swift", with: "Fixtures/SuppressTopLevelGroup/Compositor_Services_value.plist")
    ...
    func parseImmersive_Space_App() throws {
        let fixturePath = #filePath.replacingOccurrences(of: "ParserTests/SuppressTopLevelGroupTests/SuppressTopLevelGroupTests.swift", with: "Fixtures/SuppressTopLevelGroup/Immersive_Space_App_value.plist")
        let plistData = try Data(contentsOf: URL(fileURLWithPath: fixturePath))
        let plist = try PropertyListSerialization.propertyList(from: plistData, format: nil) as! [String: Any]
