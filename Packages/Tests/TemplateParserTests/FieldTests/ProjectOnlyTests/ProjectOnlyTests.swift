...
struct ProjectOnlyTests {
    ...
    func parseEmpty() throws {
        let fixturePath = #filePath.replacingOccurrences(of: "TemplateParserTests/FieldTests/ProjectOnlyTests/ProjectOnlyTests.swift", with: "Fixtures/ProjectOnly/Empty_value.plist")
