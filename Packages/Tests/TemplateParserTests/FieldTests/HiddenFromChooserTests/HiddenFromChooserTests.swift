...
struct HiddenFromChooserTests {
    ...
    func parseApp_Entity() throws {
        let fixturePath = #filePath.replacingOccurrences(
            of: "TemplateParserTests/FieldTests/HiddenFromChooserTests/HiddenFromChooserTests.swift",
        ...
        let value = (plist["HiddenFromChooser"] as? String).flatMap { BooleanFormat.fromObjectiveCString($0) }
    ...
    func roundTripApp_Entity() throws {
        ...
        let value = (originalPlist["HiddenFromChooser"] as? String).flatMap { BooleanFormat.fromObjectiveCString($0) }
        ...
        let reparsedValue = (reparsedPlist["HiddenFromChooser"] as? String).flatMap { BooleanFormat.fromObjectiveCString($0) }
    ...
    func parseMissingHiddenFromChooser() throws {
        ...
        let value = (testPlist["HiddenFromChooser"] as? String).flatMap { BooleanFormat.fromObjectiveCString($0) }
