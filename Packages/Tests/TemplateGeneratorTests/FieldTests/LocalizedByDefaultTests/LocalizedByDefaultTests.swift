...
///
/// Tests that TemplateWriter correctly serializes LocalizedByDefault values to plist format.
...
struct LocalizedByDefaultTests {
    ...
    func generateStrings_File_(Legacy)() throws {
        ...
        let fixturePath = #filePath.replacingOccurrences(of: "TemplateGeneratorTests/FieldTests/LocalizedByDefaultTests/LocalizedByDefaultTests.swift", with: "Fixtures/LocalizedByDefault/Strings_File_(Legacy)_value.plist")
    ...
    func generateStringsdict_File_(Legacy)() throws {
        // Load original fixture
        let fixturePath = #filePath.replacingOccurrences(of: "TemplateGeneratorTests/FieldTests/LocalizedByDefaultTests/LocalizedByDefaultTests.swift", with: "Fixtures/LocalizedByDefault/Stringsdict_File_(Legacy)_value.plist")
        let originalData = try Data(contentsOf: URL(fileURLWithPath: fixturePath))
        let originalPlist = try PropertyListSerialization.propertyList(from: originalData, format: nil) as! [String: Any]
