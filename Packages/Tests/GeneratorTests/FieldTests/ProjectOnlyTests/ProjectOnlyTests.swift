...
///
/// Tests that Template.Generator.Writer correctly serializes ProjectOnly values to plist format.
...
struct ProjectOnlyTests {
    ...
    func generateEmpty() throws {
        ...
        let fixturePath = #filePath.replacingOccurrences(
            of: "GeneratorTests/FieldTests/ProjectOnlyTests/ProjectOnlyTests.swift",
