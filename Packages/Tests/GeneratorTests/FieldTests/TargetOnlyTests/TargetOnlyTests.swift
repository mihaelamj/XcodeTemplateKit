...
///
/// Tests that Template.Generator.Writer correctly serializes TargetOnly values to plist format.
...
struct TargetOnlyTests {
    ...
    func generateAggregate() throws {
        ...
        let fixturePath = #filePath.replacingOccurrences(
            of: "GeneratorTests/FieldTests/TargetOnlyTests/TargetOnlyTests.swift",
