...
///
/// Tests that Template.Generator.Writer correctly serializes Description values to plist format.
...
struct DescriptionTests {
    ...
    func generateAggregate() throws {
        ...
        let fixturePath = #filePath.replacingOccurrences(
            of: "GeneratorTests/FieldTests/DescriptionTests/DescriptionTests.swift",
