...
///
/// Tests that Template.Generator.Writer correctly serializes HiddenFromChooser values to plist format.
...
struct HiddenFromChooserTests {
    ...
    func generateApp_Entity() throws {
        ...
        let fixturePath = #filePath.replacingOccurrences(
            of: "GeneratorTests/FieldTests/HiddenFromChooserTests/HiddenFromChooserTests.swift",
