...
///
/// Tests that Template.Generator.Writer correctly serializes PackageType values to plist format.
...
struct PackageTypeTests {
    ...
    func generateBuild_Tool_Plug_in() throws {
        ...
        let fixturePath = #filePath.replacingOccurrences(
            of: "GeneratorTests/FieldTests/PackageTypeTests/PackageTypeTests.swift",
