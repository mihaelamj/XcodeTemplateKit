...
///
/// Tests that Template.Generator.Writer correctly serializes NameOfInitialFileForEditor values to plist format.
...
struct NameOfInitialFileForEditorTests {
    ...
    func generateApp() throws {
        ...
        let fixturePath = #filePath.replacingOccurrences(
            of: "GeneratorTests/FieldTests/NameOfInitialFileForEditorTests/NameOfInitialFileForEditorTests.swift",
