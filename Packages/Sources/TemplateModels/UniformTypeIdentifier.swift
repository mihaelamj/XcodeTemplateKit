...
/// let allowedTypes: [UniformTypeIdentifier] = [.swiftSource]
///
/// // C-family source files
/// let allowedTypes: [UniformTypeIdentifier] = [.cSource, .cPlusPlusSource, .objectiveCSource]
///
/// // Parse from string
/// let uti = UniformTypeIdentifier(rawValue: "public.swift-source") // .swiftSource
/// ```
...
extension UniformTypeIdentifier: CaseIterable {
    /// All known UTI types (excludes `.unknown`).
    public static var allCases: [UniformTypeIdentifier] {
        [
            // Source Code
