...
extension Template.Generator {
    ...
    public struct Writer {
        ...
        public func write(
            _ metadata: Models.Template.Model.Metadata,
            to url: URL,
        ...
        public func createPlist(from metadata: Models.Template.Model.Metadata) throws -> [String: Any] {
        ...
        /// - Throws: Serialization errors
        private func serializeComponents(_ components: Models.Template.Model.Components) throws -> [[String: Any]] {
        ...
        /// - Throws: Serialization errors
        private func serializeComponent(_ component: Models.Template.Model.Component) throws -> [String: Any] {
            var dict: [String: Any] = [:]
        ...
        /// - Throws: Serialization errors
        private func serializeTargets(_ targets: Models.Template.Model.Targets) throws -> [[String: Any]] {
        ...
        /// - Returns: Dictionary representation
        /// - Throws: Serialization errors
        private func serializeTargetDefinition(_ target: Models.Template.Model.TargetDefinition) throws -> [String: Any] {
            var dict: [String: Any] = [:]
        ...
        /// - Throws: Serialization errors
        private func serializePropertyListDict(_ dict: [String: Models.Template.Model.PropertyListValue]) throws -> [String: Any] {
        ...
        /// - Throws: Serialization errors
        private func serializePropertyListValue(_ value: Models.Template.Model.PropertyListValue) throws -> Any {
            switch value {
        ...
        /// - Throws: Serialization errors
        private func serializeOptionConstraints(_ optionConstraints: Models.Template.Model.OptionConstraints) throws -> [[String: Any]] {
        ...
        /// - Throws: Serialization errors
        private func serializeDefinitions(_ definitions: Models.Template.Model.Definitions) throws -> [String: Any] {
            var result: [String: Any] = [:]
        ...
        /// - Returns: Dictionary representation
        /// - Throws: Serialization errors
        private func serializeFileDefinition(_ definition: Models.Template.Model.FileDefinition) throws -> [String: Any] {
            var dict: [String: Any] = [:]
        ...
        /// - Returns: Dictionary representation
        /// - Throws: Serialization errors
        private func serializeAssetGeneration(_ config: Models.Template.Model.AssetGenerationConfig) throws -> [String: Any] {
            var dict: [String: Any] = [:]
        ...
        /// - Returns: Dictionary representation
        /// - Throws: Serialization errors
        private func createOptionPlist(from option: Models.Template.Model.Option) throws -> [String: Any] {
        ...
        /// - Returns: Dictionary representation
        /// - Throws: Serialization errors
        private func createUnitPlist(from unit: Models.Template.Model.OptionUnit) throws -> [String: Any] {
