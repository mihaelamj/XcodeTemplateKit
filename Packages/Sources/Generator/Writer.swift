...
extension Template.Generator {
    ...
    public func write(
        _ metadata: TemplateModels.Template.Model.Metadata,
        to url: URL,
    ...
    public func createPlist(from metadata: TemplateModels.Template.Model.Metadata) throws -> [String: Any] {
    ...
    /// - Throws: Serialization errors
    private func serializeComponents(_ components: TemplateModels.Template.Model.Components) throws -> [[String: Any]] {
    ...
    /// - Throws: Serialization errors
    private func serializeComponent(_ component: TemplateModels.Template.Model.Component) throws -> [String: Any] {
        var dict: [String: Any] = [:]
    ...
    /// - Throws: Serialization errors
    private func serializeTargets(_ targets: TemplateModels.Template.Model.Targets) throws -> [[String: Any]] {
    ...
    /// - Returns: Dictionary representation
    /// - Throws: Serialization errors
    private func serializeTargetDefinition(_ target: TemplateModels.Template.Model.TargetDefinition) throws -> [String: Any] {
        var dict: [String: Any] = [:]
    ...
    /// - Throws: Serialization errors
    private func serializePropertyListDict(_ dict: [String: TemplateModels.Template.Model.PropertyListValue]) throws -> [String: Any] {
    ...
    /// - Throws: Serialization errors
    private func serializePropertyListValue(_ value: TemplateModels.Template.Model.PropertyListValue) throws -> Any {
        switch value {
    ...
    /// - Throws: Serialization errors
    private func serializeOptionConstraints(_ optionConstraints: TemplateModels.Template.Model.OptionConstraints) throws -> [[String: Any]] {
    ...
    /// - Throws: Serialization errors
    private func serializeDefinitions(_ definitions: TemplateModels.Template.Model.Definitions) throws -> [String: Any] {
        var result: [String: Any] = [:]
    ...
    /// - Returns: Dictionary representation
    /// - Throws: Serialization errors
    private func serializeFileDefinition(_ definition: TemplateModels.Template.Model.FileDefinition) throws -> [String: Any] {
        var dict: [String: Any] = [:]
    ...
    /// - Returns: Dictionary representation
    /// - Throws: Serialization errors
    private func serializeAssetGeneration(_ config: TemplateModels.Template.Model.AssetGenerationConfig) throws -> [String: Any] {
        var dict: [String: Any] = [:]
    ...
    /// - Returns: Dictionary representation
    /// - Throws: Serialization errors
    private func createOptionPlist(from option: TemplateModels.Template.Model.Option) throws -> [String: Any] {
    ...
    /// - Returns: Dictionary representation
    /// - Throws: Serialization errors
    private func createUnitPlist(from unit: TemplateModels.Template.Model.OptionUnit) throws -> [String: Any] {
