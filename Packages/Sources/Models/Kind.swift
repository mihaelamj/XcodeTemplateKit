...
extension Template.Model {
    ...
    /// let utilityKind = Template.Kind.storageType
    ...
    /// assert(Template.Kind.allCases.filter { $0.isUtilityTemplate }.allSatisfy { $0.isBaseTemplate })
    ///
    /// // User-selectable templates are neither base nor utility
    /// let userTemplates = Template.Kind.allCases.filter { !$0.isBaseTemplate }
    /// assert(userTemplates.allSatisfy { !$0.isUtilityTemplate })
    ///
    /// // Package templates are never base or utility templates
    /// let packageTemplates = Template.Kind.allCases.filter { $0.category == .packageTemplates }
    ...
    ///   `ProjectParser.loadWithAncestors()` which merges inherited options and nodes.
    ///
    ...
    public enum Kind: Hashable, Codable, Sendable {
        ...
        /// ## Example
        /// ```swift
        /// Template.Kind.app.rawValue
        /// // Returns: "com.apple.dt.unit.multiPlatform.app"
        ///
        /// Template.Kind.libraryPackage.rawValue
        /// // Returns: "com.apple.dt.packageTemplate.Library"
        ///
        /// Template.Kind.unknown("custom.template").rawValue
        ...
        ///
        /// Creates a `Template.Kind` from the template's unique identifier.
        /// Returns `.unknown(rawValue)` if the identifier is not recognized.
        ///
        /// ## Example
        /// ```swift
        /// let kind = Template.Kind(rawValue: "com.apple.dt.unit.multiPlatform.app")
        /// // Returns: .app
        ///
        /// let unknownKind = Template.Kind(rawValue: "custom.unknown.template")
        ...
        /// ## Example
        /// ```swift
        /// Template.Kind.app.displayName
        /// // Returns: "App"
        ///
        /// Template.Kind.multiplatformSwiftUIDocumentApp.displayName
        /// // Returns: "Multiplatform SwiftUI Document App"
        ///
        /// Template.Kind.iosSafariExtensionApp.displayName
        /// // Returns: "iOS Safari Extension App"
        ///
        /// Template.Kind.applicationBase.displayName
        /// // Returns: "Application Base"
        ///
        /// Template.Kind.buildToolPlugin.displayName
        ...
        /// ## Example
        /// ```swift
        /// Template.Kind.app.category
        /// // Returns: Template.Category.projectTemplates
        ///
        /// Template.Kind.framework.category
        /// // Returns: Template.Category.projectTemplates
        ///
        /// Template.Kind.libraryPackage.category
        /// // Returns: Template.Category.packageTemplates
        ///
        /// Template.Kind.swiftMacro.category
        /// // Returns: Template.Category.packageTemplates
        ///
        /// Template.Kind.applicationBase.category
        /// // Returns: Template.Category.projectTemplates (base templates are project templates)
        /// ```
        ///
        ...
        public var category: Category {
            ...
            case .fileTemplateSwiftFile, .fileTemplateObjectiveCFile, .fileTemplateCFile,
                 ...
                 .fileTemplateAppPrivacy, .fileTemplateObjectiveCNewSuperclass, .fileTemplateTextSubstitution,
                 .fileTemplateTextSubstitutionKit, .fileTemplateRefactoringNewSuperclass,
                 .fileTemplateTestPlanEditor, .fileTemplateSiriAppEntity, .fileTemplateSiriTransientAppEntity,
                 .fileTemplateSiriAppEnumeration, .fileTemplateSiriIntent, .fileTemplateSiriLinkAction:
        ...
        /// ## Example
        /// ```swift
        /// Template.Kind.base.isBaseTemplate                 // true
        /// Template.Kind.applicationBase.isBaseTemplate      // true
        /// Template.Kind.app.isBaseTemplate                  // false (user-selectable)
        /// Template.Kind.framework.isBaseTemplate            // false (user-selectable)
        /// ```
