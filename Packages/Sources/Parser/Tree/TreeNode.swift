...
///     ]
    ...
    public let id: String
    public let category: TemplateModels.Template.Model.Category
    ...
    public init(
        id: String,
        category: TemplateModels.Template.Model.Category,
...
///     ]
    ...
    public init(
        id: String,
        kind: TemplateModels.Template.Model.Kind,
...
///     choices: nil  // Checkboxes don't have choices
    ...
    public let type: TemplateModels.Template.Model.OptionType
    ...
    public init(
        ...
        name: String,
        identifier: String,
        type: TemplateModels.Template.Model.OptionType,
        defaultValue: String,
        details: [DetailNode],
        choices: ChoicesNode?
    ) {
