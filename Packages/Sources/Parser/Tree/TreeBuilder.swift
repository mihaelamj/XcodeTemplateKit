...
/// }
    ...
    ///
        ...
        public static func buildTree(from jsonData: Data) throws -> Node {
            ...
            let inventory = try decoder.decode(TemplateModels.Template.Model.Inventory.self, from: jsonData)
    ...
    ///
        ...
        /// - Returns: Root node of the template tree
        public static func buildTree(from inventory: TemplateModels.Template.Model.Inventory) -> Node {
        // Group templates by category, then by kind
        var categorizedTemplates: [TemplateModels.Template.Model.Category: [TemplateModels.Template.Model.Kind: [TemplateModels.Template.Model.Metadata]]] = [:]
        ...
        private static func buildTemplateNode(from metadata: TemplateModels.Template.Model.Metadata) -> TemplateNode {
        ...
        private static func buildOptionNode(from option: TemplateModels.Template.Model.Option, parentPath: String) -> Node {
        let optionType = TemplateModels.Template.Model.OptionType(rawValue: option.type) ?? .text
