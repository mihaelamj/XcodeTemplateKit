...
extension Template.Parser.Metadata {
    // Note: TemplatePlatform is now TemplateModels.Template.Model.Platform in Models module
...
///
    ...
    /// ## Example
    /// ```swift
    /// appTemplate.kind         // TemplateModels.Template.Model.Kind.app
    /// frameworkTemplate.kind   // TemplateModels.Template.Model.Kind.framework
    /// baseTemplate.kind        // TemplateModels.Template.Model.Kind.applicationBase
    /// ```
    public let kind: TemplateModels.Template.Model.Kind
    ...
    public let ancestors: [TemplateModels.Template.Model.BaseTemplateKind]?
    ...
    /// ```
    public let platforms: [TemplateModels.Template.Model.Platform]?
    ...
    public let fileStructure: [TemplateModels.Template.Model.FileNode]?
