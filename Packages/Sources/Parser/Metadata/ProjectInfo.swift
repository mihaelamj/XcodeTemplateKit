...
extension Template.Parser.Metadata {
    // Note: TemplatePlatform is now Models.Template.Model.Platform in Models module
    ...
    /// ```swift
    /// // Ancestors are resolved using ProjectParser.loadWithAncestors()
    ...
    public struct ProjectInfo: Codable, Sendable {
        ...
        /// ## Example
        /// ```swift
        /// appTemplate.kind         // Models.Template.Model.Kind.app
        /// frameworkTemplate.kind   // Models.Template.Model.Kind.framework
        /// baseTemplate.kind        // Models.Template.Model.Kind.applicationBase
        /// ```
        ...
        /// ```
        ///
        /// - Note: Ancestor resolution happens via `ProjectParser.loadWithAncestors()`,
        ///   which merges options and nodes from all ancestors in the inheritance chain.
        ///
        /// - SeeAlso: `Template.BaseTemplateKind` for the complete list of valid ancestor templates.
        public let ancestors: [Models.Template.Model.BaseTemplateKind]?
        ...
        /// ```
        public let platforms: [Models.Template.Model.Platform]?
        ...
        ///   (generated by `Generator.swift`). When parsing directly from Xcode's
        ...
        ///
        /// - SeeAlso: `Template.FileNode` for the structure of individual file/directory nodes.
        public let fileStructure: [Models.Template.Model.FileNode]?
