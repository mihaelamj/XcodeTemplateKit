...
class AudioUnitHostModel {
    ...
    init(type: String = "___VARIABLE_audioUnitTypeCode___", subType: String = "___VARIABLE_audioUnitSubtypeCode___", manufacturer: String = "___VARIABLE_audioUnitManufacturerCode___") {
        self.type = type
