...
#import "___PACKAGENAMEASIDENTIFIER___BufferedAudioBus.hpp"
...
public:
    ...
    void process(std::span<float const*> inputBuffers, std::span<float *> outputBuffers, AUEventSampleTime bufferStartTime, AUAudioFrameCount frameCount) {
        /*
         ...
         modify the check in [___PACKAGENAMEASIDENTIFIER___AudioUnit allocateRenderResourcesAndReturnError]
         */
