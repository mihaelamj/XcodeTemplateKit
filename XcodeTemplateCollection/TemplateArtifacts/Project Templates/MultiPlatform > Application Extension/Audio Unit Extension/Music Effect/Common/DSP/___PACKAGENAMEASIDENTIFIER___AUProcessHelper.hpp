...
#include "___PACKAGENAMEASIDENTIFIER___BufferedAudioBus.hpp"

//MARK:- AUProcessHelper Utility Class
class AUProcessHelper
{
public:
    AUProcessHelper(___PACKAGENAMEASIDENTIFIER___DSPKernel& kernel, BufferedInputBus& bufferedInputBus)
    : mKernel{kernel},
