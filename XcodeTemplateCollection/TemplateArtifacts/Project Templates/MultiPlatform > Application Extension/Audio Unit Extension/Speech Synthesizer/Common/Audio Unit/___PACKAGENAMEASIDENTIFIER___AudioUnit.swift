...
public class ___PACKAGENAMEASIDENTIFIER___AudioUnit: AVSpeechSynthesisProviderAudioUnit, @unchecked Sendable
{
    ...
    @objc override init(componentDescription: AudioComponentDescription, options: AudioComponentInstantiationOptions) throws {
        let basicDescription = AudioStreamBasicDescription(mSampleRate: 22_050.0,
